...
inputtedTerms = {'Levi': 'Olevsky', 'Elephant': 'Big Gray Animal', 'Mouse': 'Small Gray Animal', 'Zebra': 'Medium Gray Animal', 'Helen': 'Ye'}
...
def rewritePage():
    line1 = "inputtedTerms = {'Levi': 'Olevsky', 'Elephant': 'Big Gray Animal', 'Mouse': 'Small Gray Animal', 'Zebra': 'Medium Gray Animal', 'Helen': 'Ye'}"
